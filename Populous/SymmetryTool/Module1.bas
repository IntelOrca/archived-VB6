...
Public Function ChrWord(IString As String) As Integer
Dim LoByte, HiByte As Integer, Xword As Integer
LoByte = Asc(Mid(IString, 1, 1))
HiByte = Asc(Mid(IString, 2, 1))
ChrWord = LoByte + HiByte * 256
End Function
Public Function WordChr(Xword As Integer) As String
Dim LoByte, HiByte As Integer
LoByte = Xword Mod 256
HiByte = Int(Xword / 256)
WordChr = Chr(LoByte) & Chr(HiByte)
End Function
